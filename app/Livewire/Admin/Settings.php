...
class Settings extends Component
{
    ...
    public array $fields = [
        ...
        'stat_graduation' => 'Statistik - Lulusan (angka)',
        'stat_graduation_label' => 'Statistik - Lulusan (label)',
        'stat_graduation_short' => 'Statistik - Lulusan (label pendek, halaman PPDB)',
        'stat_facility' => 'Statistik - Fasilitas (angka)',
        'stat_facility_label' => 'Statistik - Fasilitas (label)',
        'visi' => 'Visi',
        'misi' => 'Misi',
