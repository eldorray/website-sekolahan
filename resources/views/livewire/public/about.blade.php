...
<div>
    ...
    <section class="py-12 animate-fade-up delay-200">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8">
            <div
                class="liquid-glass rounded-[2rem] p-8 border border-white/80 apple-transition hover:-translate-y-1 hover:shadow-lg">
                <div
                    class="w-12 h-12 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mb-6 shadow-inner">
            ...
            <div
                class="liquid-glass rounded-[2rem] p-8 border border-white/80 apple-transition hover:-translate-y-1 hover:shadow-lg">
                <div
                    class="w-12 h-12 rounded-full bg-orange-100 text-orange-500 flex items-center justify-center mb-6 shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
