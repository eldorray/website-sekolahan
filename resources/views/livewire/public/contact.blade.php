    ...
    <section class="py-8 animate-fade-up">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold text-slate-900 drop-shadow-sm">Hubungi <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-brand-500 to-brand-700">Sekolah</span>
                </h1>
            </div>
        </div>
    </section>
                ...
                <div
                    ...
                    <div class="space-y-4 text-[14px] font-medium text-slate-600">
                        <div class="flex gap-4 p-3 rounded-xl hover:bg-white/50 transition-colors"><span
                                class="font-bold w-24 text-slate-900 shrink-0">Alamat</span><span>{{ Setting::get('address') }}</span>
                        </div>
                        <div class="flex gap-4 p-3 rounded-xl hover:bg-white/50 transition-colors"><span
                                class="font-bold w-24 text-slate-900 shrink-0">Telepon</span><span>{{ Setting::get('phone') }}</span>
                        </div>
                        <div class="flex gap-4 p-3 rounded-xl hover:bg-white/50 transition-colors"><span
