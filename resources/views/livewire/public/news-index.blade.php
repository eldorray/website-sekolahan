    ...
    <section class="py-8 animate-fade-up">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold text-slate-900 drop-shadow-sm">Berita & <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-brand-500 to-brand-700">Artikel</span>
                </h1>
            </div>
        </div>
    </section>
